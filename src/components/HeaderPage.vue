...
<template>
  <header class="bg-white">
    <nav class="flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <RouterLink to="/maison" class="text-sm font-semibold leading-6 text-gray-900"
          >Liste des maison</RouterLink
        >
        <RouterLink to="/listsupabase" class="text-sm font-semibold leading-6 text-gray-900"
          >Liste des maison supabase</RouterLink
        >
